...
OUTDIR="${OUTDIR:-eval_runs/mira25_kimi_local_${STAMP}}"
LOG_FILE="${LOG_FILE:-logs/${STAMP}-mira25-kimi-local.log}"

export OPENAI_API_KEY="${OPENAI_API_KEY:-local}"
export OPENAI_BASE_URL="${OPENAI_BASE_URL:-http://127.0.0.1:8000/v1}"
export OPENAI_MODEL="${OPENAI_MODEL:-kimi-k2.5-local}"
export OPENAI_REASONING_BACKEND="${OPENAI_REASONING_BACKEND:-kimi_k2}"
